...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2019 at 02:16 PM
...
--
ALTER TABLE `connect_group_admins`
  ADD CONSTRAINT `connect_group_admins_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`User_id`),
...
--
ALTER TABLE `friends`
  ADD CONSTRAINT `friends_ibfk_1` FOREIGN KEY (`friend_id`) REFERENCES `user` (`User_id`),
  ADD CONSTRAINT `friends_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`User_id`);

--
-- Constraints for table `message`
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`receiver_id`) REFERENCES `user` (`User_id`),
...
--
ALTER TABLE `post_attachment`
  ADD CONSTRAINT `post_attachment_ibfk_1` FOREIGN KEY (`User_Id`) REFERENCES `user` (`User_id`),
...
--
ALTER TABLE `user_connect_group`
  ADD CONSTRAINT `user_connect_group_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`User_id`),
